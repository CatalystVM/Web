@extends('stern.layouts.main', ['title' => 'Dashboard'])
...
<div class="w-full px-6 mx-auto">
						...
						<div class="flex-auto p-4">
							<div class="flex flex-wrap -mx-3">
								<div class="flex-none w-2/3 max-w-full px-3">
									<div>
										<p class="mb-0 font-sans font-semibold leading-normal text-sm dark:opacity-60">Today's Money</p>
					...
					<div class="relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
						<div class="flex-auto p-4">
							<div class="flex flex-wrap -mx-3">
								<div class="flex-none w-2/3 max-w-full px-3">
									<div>
										<p class="mb-0 font-sans font-semibold leading-normal text-sm dark:opacity-60">Today's Users</p>
										<h5 class="mb-0 font-bold dark:text-white">
											2,300
					...
					<div class="relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
						<div class="flex-auto p-4">
							<div class="flex flex-wrap -mx-3">
								<div class="flex-none w-2/3 max-w-full px-3">
									<div>
										<p class="mb-0 font-sans font-semibold leading-normal text-sm dark:opacity-60">New Clients</p>
										<h5 class="mb-0 font-bold dark:text-white">
											+3,462
					...
					<div class="relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
						<div class="flex-auto p-4">
							<div class="flex flex-wrap -mx-3">
								<div class="flex-none w-2/3 max-w-full px-3">
									<div>
										<p class="mb-0 font-sans font-semibold leading-normal text-sm dark:opacity-60">Sales</p>
										<h5 class="mb-0 font-bold dark:text-white">
											$103,430
	...
	<div class="flex flex-wrap mt-6 -mx-3">
			...
			<div class="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
				<div class="flex-auto p-4">
					<div class="py-4 pr-1 mb-4 bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 rounded-xl">
						<div>
							<canvas id="chart-bars" class="chart-canvas" height="170" style="display: block; box-sizing: border-box; height: 170px; width: 513.3px;" width="513"></canvas>
						</div>
					</div>
					<h6 class="mt-6 mb-0 ml-2 dark:text-white">Active Users</h6>
					<p class="ml-2 leading-normal text-sm dark:opacity-60">(<span class="font-bold">+23%</span>) than last week</p>
		...
		<div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
			<div class="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
				...
				<div class="flex-auto p-4">
					<div>
						<canvas id="chart-line" height="300" style="display: block; box-sizing: border-box; height: 300px; width: 746.7px;" width="746"></canvas>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="flex flex-wrap -mx-3">
		<div class="w-full max-w-full px-3 flex-0">
			<div id="globe" class="absolute right-0 mt-24 lg-max:overflow-hidden top-1/10 sm:mt-4 lg:mr-24 peekaboo">
				<canvas width="700" height="648" class="w-3/4 -mr-48 h-3/4 lg-max:w-full lg:mt-12 lg:mr-0 lg:w-full" style="width: 700px; height: 648px;"></canvas>
			</div>
		</div>
	</div>
